...
function showOpeningPage() {
  const openingText = [
    ...
    `${config.nBack}-back`,
    "Rules:",
    "1. Remember the color of the last mushroom that appeared",
    "2. Use arrow keys to move Mario:",
    " - Right key to collect the mushroom",
    " - Up to jump (avoid mushroom if needed)",
    `3. Collect mushrooms that match the color from ${config.nBack} step ago.`,
