...
function showOpeningPage() {
    const openingText = [
        ...
        "0-back",
        "Rules:",
        "1. Memorize the target mushroom shown at the start of the level.",
        ...
        "4. The target mushroom will disappear when you start the game.",
        "",
        "Good luck and have fun!",
        "Press 'Start' to see the target."
    ];
