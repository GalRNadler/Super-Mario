...
function showOpeningPage() {
    const openingText = [
       ...
       "Instructions:",
        "",
        "You will see a sequence of mushrooms presented one at a time.",
        "",
        "they will appear from the right hand side.",
        "",
        "Your task is to determine if the mushroom on the screen  ",
        "",
        "matches the target mushroom for the current round.",
        "",
        "The target can be the same as the target mushroom (0-back) or",
        "",
        "the mushroom that appeared N mushrooms before (for N = 1, 2, or 3).",
        "",
        "If the mushroom is a match, press the right arrow key as fast as possible. " ,
        "",
        "If the mushroom is not a match, avoid it."
    ];
